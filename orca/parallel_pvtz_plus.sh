...
if grep -q "TOTAL RUN TIME:" log; then
    ...
    #/work2/09730/whe1/frontera/orca/orca/orca run.inp > log '-v --report-bindings -machinefile my_hostfile'
    /work2/09730/whe1/frontera/orca/orca/orca run.inp > log '-machinefile my_hostfile'
    rm my_ibrun
    rm my_hostfile
fi
